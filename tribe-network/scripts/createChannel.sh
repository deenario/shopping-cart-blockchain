...
infoln "Joining tribe1 peer to the channel..."
joinChannel 1
infoln "Joining tribe2 peer to the channel..."
joinChannel 2

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for tribe1..."
setAnchorPeer 1
infoln "Setting anchor peer for tribe2..."
setAnchorPeer 2
